...
public class TeeHee_Smart extends AdvancedRobot {
	...
	@Override
	public void run() {
		setColors(Color.ORANGE, Color.BLACK, Color.DARK_GRAY);
	...
	private void criarBC() {
		String ficheroRegras = System.getProperty("robot.regras", TeeHee_Smart.REGRAS);

		DEBUG.mensagem("criar BC");
		kbuilder = KnowledgeBuilderFactory.newKnowledgeBuilder();

		DEBUG.mensagem("Carregar regras a partir de: "+ficheroRegras);
		kbuilder.add(ResourceFactory.newClassPathResource(ficheroRegras, TeeHee_Smart.class), ResourceType.DRL);
